...
// ============================================================================
// PARTY DEFINITIONS (2026 campaign-calibrated baseline)
// ============================================================================
const PARTIES = [
  { id: "S",   m: 38, s: 2.5, lr: 3, bloc: "red",   subGroup: "S",   govEligible: true,  pmEligible: true  },
  { id: "SF",  m: 23, s: 2.1, lr: 2, bloc: "red",   subGroup: "SF",  govEligible: true,  pmEligible: false },
  ...
  { id: "ALT", m: 4,  s: 0.9, lr: 2, bloc: "red",   subGroup: null,  govEligible: false, pmEligible: false,
    threshold: true, baseVoteShare: 2.1, thresholdPct: 2.0, pClear: 0.60 },
  { id: "RV",  m: 9,  s: 1.5, lr: 4, bloc: "red",   subGroup: null,  govEligible: true,  pmEligible: false },
  { id: "M",   m: 9,  s: 1.5, lr: 5, bloc: "swing", subGroup: null,  govEligible: true,  pmEligible: true  },
  { id: "KF",  m: 12, s: 1.5, lr: 6, bloc: "blue",  subGroup: null,  govEligible: true,  pmEligible: false },
  { id: "V",   m: 17, s: 1.7, lr: 7, bloc: "blue",  subGroup: "V",   govEligible: true,  pmEligible: true  },
  { id: "LA",  m: 19, s: 1.9, lr: 9, bloc: "blue",  subGroup: "LA",  govEligible: true,  pmEligible: true  },
  { id: "DD",  m: 13, s: 1.6, lr: 7, bloc: "blue",  subGroup: "DD",  govEligible: true,  pmEligible: false },
  { id: "DF",  m: 14, s: 1.5, lr: 7, bloc: "blue",  subGroup: "DF",  govEligible: false, pmEligible: false },
  { id: "BP",  m: 5,  s: 1.1, lr: 8, bloc: "blue",  subGroup: null,  govEligible: false, pmEligible: false,
    threshold: true, baseVoteShare: 2.8, thresholdPct: 2.0, pClear: 0.75 },
];
